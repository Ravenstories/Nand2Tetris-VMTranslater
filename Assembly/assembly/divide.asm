//Divide of two numbers in Hack assembly language
(START)
...
(LOOP)
    @R0        // Load the first number into the A-register
    ...
    D=M
    @END
    D;JLT       // If B == 0, jump to the END label

    @R2        // Load the current result into the A-register
